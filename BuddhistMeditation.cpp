...
int main(int argc, char const *argv[])
{
  ...
  void Sati();
  Sati();
  cout << "This is the concentration level: " << Concentration << endl;
  return 0;
}
...
void Sati()
{
  ...
  Concentration++; // "Mindfulness of the body will lead easily too the development of deep concentration"(Analayo pg.124)
  ...
  // "Once mindfulness has pushed these mental defilements aside, more wholesome states of mind can take their place" (Gunaratana pg. 159)
